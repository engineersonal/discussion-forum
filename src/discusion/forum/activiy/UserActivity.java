...
public class UserActivity {
	...
	public void deleteQuestion(UserActivity userActivity, User user) throws NumberFormatException, IOException {
		...
		// else if condition to check if the user is a moderator
		else if(user.getUserRole() == UserRole.MODERATOR){
			// if condition to check if the user is a regular user
			if(question.getUser().getUserRole() == UserRole.USER){
				questionService.deleteQuestion(question);
			}
			// Or the current user is also the user who wrote the question
			...
			//the current user is also the user who wrote the question
